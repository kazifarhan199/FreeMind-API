...
def sendWearableRecommendations(instance_id, config_id):
    ...
    if (instance.optimal):
        final_reason= "Congratulations\U0001F973, You did a great job! "+"\n\nRecommendation: "+recommendation.type+": "+ recommendation.source_based +"\n\n"+ reason
    else:
        final_reason= "Recommendation: "+recommendation.type+": "+ recommendation.source_based +"\n\n" + reason
